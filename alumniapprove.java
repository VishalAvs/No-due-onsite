...
/**
 * Servlet implementation class Alumniapprove
 */
@WebServlet("/Alumniapprove")
public class Alumniapprove extends HttpServlet {
	       ...
	       // rs= stmt.executeQuery("select distinct(c.Hno),c.fee,c.specialfee,b.cleared,lib.bookfee,l.due from college c,bank b,library lib,labs l where c.Hno=l.Hno and c.Hno="+b+"");
	        ...
	        if(status)
		    {
		    	...
		    	pw.println("<html><head>\r\n" + 
		    		...
		    		"</head><body><h1>FEE DETAILS :</h1><br><br><b>HALL TICKET NUMBER :</b>"+rs.getString(1)+"<br><br><b>COLLEGE FEE:</b> "+rs.getString(2)+"<br><br><b>SPECIAL FEE</b>"+rs.getString(3)+"<br><br><b>AMOUNT CLEARED :</b>"+rs.getString(4)+"<br><br><b>BOOK FEE :</b>"+rs.getString(5)+"<br><br><b>LABS FEE DUE :</b>"+rs.getString(6)+"<br><br><br><form action="+"Insertservlet"+" "+"method="+"post"+"><button type="+"submit"+" "+"class="+"button"+">APPROVE</button><br><br></form><br><br></body></html>");
