	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try
		{
		   ...
		   // ResultSet rs= stmt.executeQuery("select c.fee,c.specialfee,b.cleared,l.bookfee,lab.due from college c,bank b,library l,labs lab where c.Hno=b.Hno and b.Hno=l.Hno and l.Hno=lab.Hno;");
	        ResultSet rs= stmt.executeQuery("select c.Hno,c.fee,c.specialfee,b.cleared,lib.bookfee,l.due from college c,bank b,library lib,labs l where c.Hno=l.Hno");
	        status=rs.next();
		    if(status)
		    {
		    	...
		    	pw.println("<html><head>\r\n" + 
		    			...
		    			"}\r\n" + 
		    			"</style>\r\n" + 
		    			"</head><body><h1>FEE DETAILS :</h1><br><br><b>HALL TICKET NUMBER :</b>"+rs.getString(1)+"<br><br><b>COLLEGE FEE:</b> "+rs.getString(2)+"<br><br><b>SPECIAL FEE</b>"+rs.getString(3)+"<br><br><b>AMOUNT CLEARED :</b>"+rs.getString(4)+"<br><br><b>BOOK FEE :</b>"+rs.getString(5)+"<br><br><b>LABS FEE DUE :</b>"+rs.getString(6)+"<br><br><br><form action="+"Progressservlet"+" "+"method="+"post"+"><button type="+"submit"+"class="+"button"+">NO DUE FORM</button><br><br></form></body></html>");
